...
const achievements = [
  ...
  },
  {
    ...
    category: 'Hackathon',
    description: 'Participation in the Genius Arena Hackathon during Talent Land México 2025, one of the most important innovation and technology events in the country. We developed a centralized billing solution for the Flecha Amarilla track, working with technologies like Angular, FastAPI, and AWS Textract to automate invoice reading and processing. Experience focused on frontend development, collaborative work, and problem-solving under pressure.',
    highlights: [
